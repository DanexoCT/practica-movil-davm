  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.phoneFrame}>
        <Text style={styles.titulo}>Tareas de Dan Valle</Text>
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#474747", alignItems: "center", paddingTop: Platform.OS === "web" ? 40 : 0 },
  ...
  boton: { backgroundColor: "#eb6025", borderRadius: 10, paddingHorizontal: 16, justifyContent: "center" },
